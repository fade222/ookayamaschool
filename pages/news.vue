    ...
    <div class="pt-8 md:pt-16 xl:mx-32">
      ...
      <article class="px-4 pt-8 pb-8 tracking-wide border-b-2 border-gray-300">
        <div class="md:pl-16">
          ...
          <div class="text-sm">
            <p class="pt-2">
              ２０２０年３月２０日（金）～
              ３月２９日（日）まで春期講習会を実施します。<br />
              （小学生20時間・中学受験生以上は30時間）<br />
            </p>
            <p class="pt-4">
              ２３日・２４日・２５日はお休みです。
            </p>
      ...
      <article class="px-4 pt-8 pb-8 tracking-wide border-b-2 border-gray-300">
        <div class="md:pl-16">
          ...
          <div class="text-sm">
            <p class="pt-2">
              ２０１９年７月２２日（月）～８月２２日（木）まで夏期講習会を実施します。
            </p>
            <p class="pt-4">
              授業は１０：００～１６：００、定員は１０名です。
            </p>
